...
export function resolveLocation(found, gz = loadGazetteer()) {
  ...
  if (place && muni && !(muni.adm1 === place.adm1 && muni.adm2 === place.adm2) && muni.mentions > place.mentions && (!state || muni.adm1 === state.adm1)) place = null;
  if (place) {
