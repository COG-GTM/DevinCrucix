...
const COUNT_PATTERNS = {
  ...
  kidnapped: [
    new RegExp(`${NUM_RE_SRC}\\s+(?:people|persons|men|women|migrants|students|workers|miners|farmers|others)?\\s*(?:were |was |have been |had been |remain |are )?(?:kidnapped|abducted|missing|disappeared|taken(?!\\s+(?:to|into|in|for)\\b)|secuestrados|desaparecidos|levantados)`, 'gi'),
